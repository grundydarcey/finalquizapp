...
function generateMainPage() {
  return `
      <div class="mainPage">
        ...
        <img src="../images/download.jpg" alt="Group Photo">
...
function generateFeedbackPage(){
  ...
  if(store.currentAnswer===store.questions[store.questionNumber].correctAnswer){
    results = `<img src="../images/cheer.gif" alt="Cheering for your right answer"><br>You really know your stuff!`;
  } else{
    results = `<img src="../images/tear.gif" alt="Now you're crying"><br>Maybe it's time to hit the books.`;
  }
  return`
  <div class="mainPage">
...
function generateFinalPage(){
  let results = '';
  if (store.currentAnswer === store.questions[store.questionNumber].correctAnswer) {
    results = `<img src="../images/shake.gif" alt="You're done now!"><br>You really know your stuff!`;
  } else {
    results = `<img src="../images/nope.gif" alt="Close but no cigar"><br>Maybe it's time to hit the books.`;
  }
  return`
  <div class="mainPage">
      <h2>Question ${store.questionNumber+1}</h2>
